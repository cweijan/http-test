...
import io.github.cweijan.mock.openfeign.encoding.HttpEncoding;
...
public class DefaultGzipDecoder implements Decoder {
	...
	public Object decode(final Response response, Type type)
		...
		Collection<String> encoding = response.headers()
				.containsKey(io.github.cweijan.mock.openfeign.encoding.HttpEncoding.CONTENT_ENCODING_HEADER)
						? response.headers().get(io.github.cweijan.mock.openfeign.encoding.HttpEncoding.CONTENT_ENCODING_HEADER)
						: null;
